...
var localization = {
    en: {
        title: "Negative Binomial Tail Probabilities",
        navigation: "Negative Binomial Tail Probabilities",
        ...
        help: {
            title: "Negative Binomial Tail Probabilities",
            r_help: "help(pnbinom, package=stats)",
            body: `
...
class negativeBinomialTailProbabilities extends baseModal {
    constructor() {
        var config = {
            id: "negativeBinomialTailProbabilities",
...
module.exports.item = new negativeBinomialTailProbabilities().render()