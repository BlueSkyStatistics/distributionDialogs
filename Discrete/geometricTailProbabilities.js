...
var localization = {
    en: {
        title: "Geometric Tail Probabilities",
        navigation: "Geometric Tail Probabilities",
        varvals: "Enter variable value(s) separated by a comma. Example: 3, .5",
        prob: "Mean",
...
module.exports.item = new geometricTailProbabilities().render()