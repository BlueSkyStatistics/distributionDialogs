...
var localization = {
    en: {
        title: "Hypergeometric Tail Probabilities",
        navigation: "Hypergeometric Tail Probabilities",
        ...
        help: {
            title: "Hypergeometric Tail Probabilities",
            r_help: "help(phyper, package=stats)",
            body: `
...
class hypergeometricTailProbabilities extends baseModal {
    constructor() {
        var config = {
            id: "hypergeometricTailProbabilities",
...
module.exports.item = new hypergeometricTailProbabilities().render()