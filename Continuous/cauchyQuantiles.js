...
var localization = {
    en: {
        title: "Cauchy Quantiles",
        navigation: "Cauchy Quantiles",
        varvals: "Enter variable value(s) separated by a comma. Example: 0.3,0.2,0.5",
        location: "Location",
        scale: "Scale",
...
module.exports.item = new cauchyQuantiles().render()